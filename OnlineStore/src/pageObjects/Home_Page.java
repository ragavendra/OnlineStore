...
public class Home_Page extends BaseClass{
	...
	//Google URL only
	public static WebElement txt_GoogleSrchBox() throws Exception{
		try{ 
			element = driver.findElement(By.name("q"));
			Log.info("GoogleSrchBox is found on the Home Page");
		}catch (Exception e){
			Log.error("GoogleSrchBox is not found on the Home Page");
			throw(e);
		}
		return element;
	}
